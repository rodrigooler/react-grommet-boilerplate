...
function getIgnorePatterns(options) {
  var ignorePath = _path3.default.join(process.cwd(), '.eslintignore');
  try {
...
function getFilesByPatterns(patterns, ignore) {
  ...
  patterns.forEach(function (pattern) {
    ...
    if (isFile) {
      ...
      var newFiles = _glob2.default.sync(_path, { cwd: process.cwd(), nodir: true, ignore: ignore });
...
var Linter = function () {
  ...
  _createClass(Linter, [{
    ...
    value: function execute(patterns) {
      ...
      return new Promise(function (resolve, reject) {
        var files = getFilesByPatterns(patterns, getIgnorePatterns(_this2._options));
